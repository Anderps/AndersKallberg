...
function business_architect_default_settings($param){
	$values = array (
					 ...
					 'footer_bg_color'=> '#323537',
					 'footer_text_color'=> '#fff',
					 'header_contact_social_bg_color'=> '#185b9de8',
					 'footer_border' =>'1',
					 'hero_border' => 0 ,
					 'header_layout' =>'1',
					 'heading_font' => 'Roboto', 
...
function business_architect_activate_recommended_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      => 'One Click Demo import - Advanced Import',
...
function business_architect_help_notice() {
    ...
    $message = __( 'Note! Install recomended plugins before installing demo. Appearance -> Demo Import -> point zip file. Enable | Disable slider from customizer theme options.', 'business-architect' );
    ...
    printf( '<div class="%1$s"> <p><strong><span>%2$s</span></strong></p>
