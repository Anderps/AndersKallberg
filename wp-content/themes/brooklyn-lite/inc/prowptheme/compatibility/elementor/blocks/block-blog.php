...
class ProWPTheme_Blog extends Widget_Base {
	...
	public function get_title() {
		return __( 'ProWPTheme: Blog', 'brooklyn-lite' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'categories',
			[
				'label' => __( 'Select your categories', 'brooklyn-lite' ),
		...
		$this->add_control(
			'number',
				[
				'label'   => __( 'Number of posts', 'brooklyn-lite' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Content', 'brooklyn-lite' ),
		...
		$this->add_control(
			'heading_title',
			[
				'label' => __( 'Post Title', 'brooklyn-lite' ),
		...
		$this->add_control(
			'date_bg_color',
			[
				'label' => __( 'Background color', 'brooklyn-lite' ),
				...
				'condition' => [
					'_skin' => 'brooklyn_lite_blog_skin_4',
				],					
			]
		);		
